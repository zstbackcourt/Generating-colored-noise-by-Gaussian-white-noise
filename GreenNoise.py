...
def GreenNoise(blursigma_weak,width,height,num):
    ...
    plt.savefig('./GreenNoiseSpectrumPlot.jpg')
    plt.close()
    print("生成波形图")
    imsave('./GreenNoise.jpg', img)
    print("生成点阵图")
    imsave('./GreenNoiseSpectrum.jpg',spectrum_img)
    print("生成频谱图")


if __name__ == '__main__':
    GreenNoise(0.5,250,250,4000)